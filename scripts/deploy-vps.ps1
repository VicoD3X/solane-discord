...
$remoteEnvLines = @(
  ...
  "DISCORD_HIGHSEC_CHANNEL_ID=$($envValues["DISCORD_HIGHSEC_CHANNEL_ID"])",
  "DISCORD_PIPES_CHANNEL_ID=$($envValues["DISCORD_PIPES_CHANNEL_ID"])",
  "DISCORD_POCHVEN_CHANNEL_ID=$($envValues["DISCORD_POCHVEN_CHANNEL_ID"])",
  "DISCORD_LOWSEC_CHANNEL_ID=$($envValues["DISCORD_LOWSEC_CHANNEL_ID"])",
  "DISCORD_NSNPC_CHANNEL_ID=$($envValues["DISCORD_NSNPC_CHANNEL_ID"])",
