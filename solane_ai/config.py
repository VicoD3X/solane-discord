...
class Settings:
    ...
    def from_env(cls) -> Settings:
        return cls(
            ...
            highsec_channel_id=_optional_int("DISCORD_HIGHSEC_CHANNEL_ID"),
    ...
    def configured_channels(self) -> dict[str, int]:
        ...
        if self.highsec_channel_id:
            channels["highsec"] = self.highsec_channel_id
